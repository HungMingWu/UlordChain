...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ulord address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ulord: URIs)"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ulord Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Ulord Core"); // default title
...
void BitcoinGUI::subscribeToCoreSignals()
{
    ...
    uiInterface.ThreadSafeMessageBoxConn = uiInterface.ThreadSafeMessageBox.connect([=](auto&&... params) {
        return ThreadSafeMessageBox(this, std::forward<decltype(params)>(params)...);
    });
}
...
void BitcoinGUI::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.ThreadSafeMessageBoxConn.disconnect();
}
